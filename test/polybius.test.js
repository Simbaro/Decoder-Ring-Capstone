...
describe("polybius", () => {
  ...
  it("should maintain spaces when decoding", () => {
    let input = "44324234 343243541341 2311423344114233 345311315134";
    let expected = "th(i/j)s should ma(i/j)nta(i/j)n spaces";
    let encode = false;
    let actual = polybius(input, encode);
    expect(actual).to.equal(expected);
  });
  it("should maintain spaces when encoding", () => {
    let input = "this should maintain spaces";
    let expected = "44324234 343243541341 2311423344114233 345311315134";
    let encode = true;
    let actual = polybius(input, encode);
    expect(actual).to.equal(expected);
  });
